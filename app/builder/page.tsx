...
function Builder({ searchParams }: { searchParams: any }) {
  ...
  const data = [
    ...
    { name: 'Dob', age: 45, location: 'Pos Angeles' },
    { name: 'Dob', age: 60, location: 'Ios Angeles' },
    { name: 'Hob', age: 37, location: 'Hos Angeles' },
    { name: 'Fob', age: 90, location: 'Ros Angeles' },
      ...
      <main className="grid h-screen">
        <ResizablePanelGroup direction="vertical">
          ...
          <ResizablePanel defaultSize={10} maxSize={30} minSize={10}>
            <ResizablePanel defaultSize={10} maxSize={30} minSize={10}>
              <div className="px-4 py-1 border-b">Output</div>
              <div>
